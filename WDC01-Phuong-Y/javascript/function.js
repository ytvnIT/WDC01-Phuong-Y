...
function setImage(){
    ...
    for(i;i<=15;i++){
      ...
      //  document.body.style.backgroundImage = "url('avatar.jpg')";
       // var x='../resource/'+source[i];

        document.getElementById(i.toString()).style.backgroundImage= "url('resource/a1.jpg')";
       // document.getElementsByClassName("bg-img")[0].style.backgroundImage='url('+x+')';
...
function LoadImg(){
    ...
    for(var i=0;i<=3;i++){
         document.getElementById(i.toString()).style.backgroundImage= 'url(resource/'+img[i]+')';
